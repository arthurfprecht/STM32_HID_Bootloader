...
LIBS = -lc -lm -lnosys 
LIBDIR = 
LDFLAGS = $(MCU) -specs=nano.specs -specs=nosys.specs -T$(LDSCRIPT) $(LIBDIR) $(LIBS) -Wl,-Map=$(BUILD_DIR)/$(TARGET).map,--cref -Wl,--no-warn-rwx-segment -Wl,--no-wchar-size-warning -Wl,--gc-sections
...
$(BUILD_DIR)/%.o: %.c 401_Makefile.mk | $(BUILD_DIR) 
	$(ECHO) "CC      $<"
	$(Q)$(CC) -c $(CFLAGS) -Wa,-a,-ad,-alms=$(BUILD_DIR)/$(notdir $(<:.c=.lst)) $< -o $@

$(BUILD_DIR)/%.o: %.s 401_Makefile.mk | $(BUILD_DIR)
	$(ECHO) "AS      $<"
	$(Q)$(AS) -c $(CFLAGS) $< -o $@

$(BUILD_DIR)/$(TARGET).elf: $(OBJECTS) 401_Makefile.mk
	$(ECHO) "LD      $<"
